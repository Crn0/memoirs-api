...
const comments_reply = [
    ...
    asyncHandler(async (req, res, _) => {
        ...
        const comment = await Comment.findOneAndUpdate({ _id: commentId, isDeleted: false }, { $push: { replies: commentReply.id }}, { new: true }).populate('replies');
